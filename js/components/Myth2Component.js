export default {
    ...
    <iframe width="560" height="315" src="{{currentMediaDetails.video_id}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    methods: {
        ...
        if (localStorage.getItem["cachedVideo"]) {
            ...
            .then(data => {
                ...
                this.currentMediaDetails = data[1];
            })
